...
|---------|---------|---------|
|![eros-demo](http://upload.ouliu.net/i/20180122162536pcw67.gif)|![ios下载](https://raw.githubusercontent.com/bmfe/eros-docs/master/zh-cn/image/iosqr.png)|![android 下载](http://upload.ouliu.net/i/201801241911376ee1z.png)|
...
* 如果遇到复杂的页面，如 IM 之类的，eros 建议用原生拓展 component/module 实现，weex 应付此类需求还是比较吃力。
